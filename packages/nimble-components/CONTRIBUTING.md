...
| page-object.ts                           | Contains the page object to provide a high-level API for clients to write tests that use the component.
...
| tests/component-name.page-object.spec.ts | Unit tests for the page object.
